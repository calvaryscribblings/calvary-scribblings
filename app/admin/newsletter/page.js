...
const purple = "#6b2fad";
const s = {
  page: { display: "flex", minHeight: "100vh", background: "#f8f7fc", fontFamily: "Cormorant Garamond, Georgia, serif" },
  ...
  textarea: { width: "100%", padding: "11px 14px", border: "1px solid #ede8f5", borderRadius: 8, fontSize: 14, color: "#1a1a2e", background: "#fff", outline: "none", resize: "vertical", lineHeight: 1.6, fontFamily: "Cormorant Garamond, Georgia, serif", boxSizing: "border-box" },
  ...
  pvLogo: { color: "#fff", fontSize: 26, fontWeight: 700, fontFamily: "Cormorant Garamond, Georgia, serif", marginBottom: 4 },
  pvTagline: { color: "rgba(255,255,255,0.65)", fontSize: 12, letterSpacing: 1 },
  pvIntro: { padding: "28px 40px", fontSize: 15, color: "#1a1a2e", lineHeight: 1.75, fontFamily: "Cormorant Garamond, Georgia, serif" },
  ...
  pvStoryTitle: { fontSize: 16, fontWeight: 700, color: "#1a1a2e", fontFamily: "Cormorant Garamond, Georgia, serif", marginBottom: 4 },
