    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ad-date { display: inline-block; font-family: Cormorant Garamond, Georgia, serif; font-size: 1.05rem; color: #c4b5fd; padding: 0.6rem 1rem; border-radius: 9px; background: rgba(107,47,173,0.08); border: 1px solid rgba(107,47,173,0.22); margin-bottom: 1.65rem; }
