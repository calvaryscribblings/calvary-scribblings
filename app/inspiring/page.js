...
const DESCRIPTION = 'True grit, unlikely grace. Stories that remind you what people are capable of.';
...
const SUBCATEGORIES = [
  ...
  { value: 'Loss & Recovery', label: 'Loss & Recovery' },
];
      ...
      <section className="cat-hero" data-reveal="fade" style={{ position: 'relative', overflow: 'hidden', background: 'radial-gradient(ellipse at 50% 0%, #2a1a05 0%, #080610 65%)' }}>
        <svg viewBox="0 0 380 220" preserveAspectRatio="xMidYMid slice" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%' }}>
          <g stroke="#c9a84c" strokeWidth="0.4" opacity="0.2">
            ...
            <line x1="190" y1="0" x2="50" y2="220" />
            <line x1="190" y1="0" x2="330" y2="220" />
            <line x1="190" y1="0" x2="0" y2="140" />
            <line x1="190" y1="0" x2="380" y2="140" />
            <line x1="190" y1="0" x2="120" y2="220" />
            <line x1="190" y1="0" x2="260" y2="220" />
          </g>
        </svg>
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 50% 0%, rgba(180,120,30,0.30) 0%, transparent 60%)' }} />
