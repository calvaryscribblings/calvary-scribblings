    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .st-nav-logo { font-family: Cormorant Garamond, Georgia, serif; font-size: 1rem; font-weight: 600; color: #f5f0e8; }
        .st-nav-logo span { color: #a78bfa; }
        .st-nav-back { font-size: 0.68rem; font-weight: 500; color: rgba(255,255,255,0.38); letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; transition: color 0.2s; font-family: Cormorant Garamond, Georgia, serif; }
        ...
        .st-kicker { font-size: 0.68rem; font-weight: 500; color: rgba(155,109,255,0.55); letter-spacing: 0.2em; text-transform: uppercase; font-family: Cormorant Garamond, Georgia, serif; margin-bottom: 0.55rem; }
        .st-title { font-family: Cormorant Garamond, Georgia, serif; font-size: clamp(1.9rem, 5vw, 2.4rem); font-weight: 400; color: #ffffff; line-height: 1.05; letter-spacing: -0.01em; margin-bottom: 0.4rem; }
        .st-subtitle { font-size: 0.9rem; font-weight: 500; color: rgba(255,255,255,0.3); font-family: Cormorant Garamond, Georgia, serif; }
        ...
        .st-section-title { font-family: Cormorant Garamond, Georgia, serif; font-size: 1.18rem; color: #f5f0e8; }
        .st-section-meta { font-size: 0.62rem; font-weight: 500; color: rgba(255,255,255,0.26); letter-spacing: 0.12em; text-transform: uppercase; font-family: Cormorant Garamond, Georgia, serif; }
        ...
        .st-row-label { font-size: 0.85rem; font-weight: 500; color: rgba(255,255,255,0.3); font-family: Cormorant Garamond, Georgia, serif; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        .st-row-hint { font-size: 0.68rem; font-weight: 500; color: rgba(255,255,255,0.22); font-family: Cormorant Garamond, Georgia, serif; margin-top: 0.22rem; letter-spacing: 0.04em; }
        .st-row-action { font-size: 0.65rem; font-weight: 500; color: #9b6dff; letter-spacing: 0.1em; text-transform: uppercase; font-family: Cormorant Garamond, Georgia, serif; cursor: pointer; background: none; border: none; transition: color 0.2s; flex-shrink: 0; padding: 0; }
        .st-row-action:hover { color: #c4b5fd; }
        .st-row-action:disabled { opacity: 0.4; cursor: not-allowed; }
        .st-row-status { font-size: 0.65rem; font-weight: 500; letter-spacing: 0.08em; text-transform: uppercase; font-family: Cormorant Garamond, Georgia, serif; flex-shrink: 0; display: inline-flex; align-items: center; gap: 4px; }
        .st-row-status.verified { color: #1d9e75; }
        .st-row-status.unverified { color: rgba(248,113,113,0.6); }

        .st-msg { font-size: 0.74rem; font-weight: 500; font-family: Cormorant Garamond, Georgia, serif; margin: 0.2rem 0 0.6rem 0.25rem; }
        .st-msg.success { color: #86efac; }
        .st-msg.error { color: #f87171; }

        .st-signout { width: 100%; margin-top: 0.82rem; background: none; border: 1px solid rgba(220,38,38,0.1); border-radius: 10px; padding: 0.82rem; font-size: 0.65rem; font-weight: 600; letter-spacing: 0.16em; text-transform: uppercase; color: rgba(248,113,113,0.55); cursor: pointer; font-family: Cormorant Garamond, Georgia, serif; transition: color 0.2s, border-color 0.2s; }
        ...
        .st-modal-title { font-family: Cormorant Garamond, Georgia, serif; font-size: 1.3rem; color: #f5f0e8; }
        ...
        .st-modal-body { font-family: Cormorant Garamond, Georgia, serif; font-size: 1rem; color: rgba(240,236,230,0.78); line-height: 1.7; margin-bottom: 1.1rem; }
        .st-modal-email { display: inline-block; background: rgba(107,47,173,0.1); border: 1px solid rgba(107,47,173,0.2); border-radius: 7px; padding: 0.45rem 0.78rem; font-family: Cormorant Garamond, Georgia, serif; font-size: 0.85rem; font-weight: 500; color: #c4b5fd; margin-top: 0.4rem; word-break: break-all; }
        .st-modal-note { font-size: 0.74rem; font-weight: 500; color: rgba(255,255,255,0.26); font-family: Cormorant Garamond, Georgia, serif; line-height: 1.6; margin-bottom: 1.2rem; }
        ...
        .st-modal-success-title { font-family: Cormorant Garamond, Georgia, serif; font-size: 1.2rem; color: #f5f0e8; margin-bottom: 0.4rem; }
        .st-modal-success-msg { font-size: 0.85rem; font-weight: 500; color: rgba(255,255,255,0.42); font-family: Cormorant Garamond, Georgia, serif; line-height: 1.55; }
        .st-modal-actions { display: flex; gap: 0.6rem; margin-top: 1.2rem; }
        .st-modal-send { flex: 1; background: #7c3aed; border: none; border-radius: 9px; padding: 0.78rem; font-size: 0.7rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #fff; cursor: pointer; font-family: Cormorant Garamond, Georgia, serif; transition: background 0.2s; }
        .st-modal-send:hover { background: #6d28d9; }
        .st-modal-send:disabled { opacity: 0.4; cursor: not-allowed; }
        .st-modal-cancel { background: none; border: 1px solid rgba(255,255,255,0.08); border-radius: 9px; padding: 0.78rem 1.1rem; font-size: 0.7rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(255,255,255,0.32); cursor: pointer; font-family: Cormorant Garamond, Georgia, serif; transition: color 0.2s; }
        .st-modal-cancel:hover { color: rgba(255,255,255,0.6); }
        .st-modal-done { width: 100%; background: none; border: 1px solid rgba(167,139,250,0.3); border-radius: 9px; padding: 0.78rem; font-size: 0.7rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #a78bfa; cursor: pointer; font-family: Cormorant Garamond, Georgia, serif; margin-top: 1.2rem; transition: background 0.2s; }
        .st-modal-done:hover { background: rgba(107,47,173,0.1); }
        .st-modal-error { font-size: 0.78rem; font-weight: 500; color: #f87171; font-family: Cormorant Garamond, Georgia, serif; margin-top: 0.8rem; }
        ...
        .st-danger-label { font-size: 0.68rem; font-weight: 500; color: rgba(214,141,133,0.7); letter-spacing: 0.18em; text-transform: uppercase; font-family: Cormorant Garamond, Georgia, serif; margin-bottom: 0.65rem; }
        .st-danger-title { font-family: Cormorant Garamond, Georgia, serif; font-size: 1.1rem; color: #f5f0e8; margin-bottom: 0.4rem; }
        .st-danger-body { font-size: 0.81rem; font-weight: 500; color: rgba(232,224,212,0.5); line-height: 1.6; font-family: Cormorant Garamond, Georgia, serif; margin-bottom: 0.95rem; }
        .st-danger-body strong { color: rgba(232,224,212,0.78); font-weight: 500; }
        .st-danger-btn { background: none; border: 1px solid rgba(180,86,80,0.5); color: #d68d85; border-radius: 9px; padding: 0.7rem 1.05rem; font-size: 0.68rem; font-weight: 600; letter-spacing: 0.16em; text-transform: uppercase; font-family: Cormorant Garamond, Georgia, serif; cursor: pointer; transition: all 0.18s; }
