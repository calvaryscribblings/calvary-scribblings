    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pf-nav-back { font-size: 0.65rem; color: rgba(255,255,255,0.6); letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; transition: color 0.2s; font-family: 'Inter', sans-serif; }
        ...
        .pf-unverified { font-size: 0.62rem; color: rgba(255,255,255,0.5); font-family: 'Inter', sans-serif; letter-spacing: 0.08em; text-transform: uppercase; }
        .pf-joined { font-size: 0.7rem; color: rgba(255,255,255,0.58); font-family: 'Inter', sans-serif; margin-bottom: 0.85rem; }
        ...
        .pf-follow-label { font-size: 0.56rem; color: rgba(255,255,255,0.6); letter-spacing: 0.12em; text-transform: uppercase; font-family: 'Inter', sans-serif; }
        ...
        .pf-bio-empty { font-size: 0.82rem; color: rgba(255,255,255,0.5); font-family: 'Inter', sans-serif; cursor: pointer; font-style: italic; flex: 1; transition: color 0.2s; }
        ...
        .pf-stat-label { font-size: 0.58rem; color: rgba(255,255,255,0.6); letter-spacing: 0.16em; text-transform: uppercase; font-family: 'Inter', sans-serif; }
        ...
        .pf-section-meta { font-size: 0.6rem; color: rgba(255,255,255,0.52); letter-spacing: 0.12em; text-transform: uppercase; font-family: 'Inter', sans-serif; }
        ...
        .pf-story-author { font-size: 0.68rem; color: rgba(255,255,255,0.58); font-family: 'Inter', sans-serif; margin-top: 2px; }
        ...
        .pf-progress-next { font-size: 0.65rem; color: rgba(255,255,255,0.52); font-family: 'Inter', sans-serif; }
        ...
        .pf-placeholder p { font-size: 0.88rem; color: rgba(255,255,255,0.5); font-family: 'Cormorant Garamond', Georgia, serif; font-style: italic; }
        ...
        .pf-modal-close { background: none; border: none; color: rgba(255,255,255,0.6); font-size: 1.4rem; cursor: pointer; padding: 0; line-height: 1; transition: color 0.2s; }
        ...
        .pf-field-label { font-size: 0.62rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(255,255,255,0.6); font-family: 'Inter', sans-serif; margin-bottom: 0.4rem; display: block; }
        ...
        .pf-field-hint { font-size: 0.62rem; color: rgba(255,255,255,0.45); font-family: 'Inter', sans-serif; margin-top: 0.3rem; }
        ...
        .pf-modal-cancel { background: none; border: 1px solid rgba(255,255,255,0.1); border-radius: 10px; padding: 0.8rem 1.25rem; font-size: 0.68rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(255,255,255,0.6); cursor: pointer; font-family: 'Inter', sans-serif; }
