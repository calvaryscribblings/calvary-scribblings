export const stories = [
  ...
  { id: 'rise-and-shine', title: 'Rise and Shine', category: 'flash', categoryName: 'Flash Fiction', url: '/stories/rise-and-shine', cover: '/rise-and-shine-cover.jpeg', author: 'Ufedo Adaji', date: 'Mar 21, 2026', content: `<p>The alarm went off at five.</p><p>Nkechi didn't reach for the snooze button. She never did anymore — not since the morning she missed it, and missed everything else that followed.</p><p>She sat up slowly, swinging her feet to the cold floor the way her mother taught her. <em>Both feet, all at once. Don't negotiate with yourself before the sun comes up.</em></p><p>The curtains were thin. Lagos light leaked through them like something impatient, like something that had places to be. She let it fall across her hands while she prayed — not on her knees, not with any formal words, just the way a person holds a conversation they've been putting off.</p><p>The kettle clicked on. She stood at the window.</p><p>Below, the street was already alive: a bread seller balancing a tray on her head with the carelessness of someone who'd been doing it since before she could remember. A young man hosing down a car that didn't belong to him. A child in a school uniform too big for her body, walking with the gravity of someone carrying important news.</p><p><em>They are already at it</em>, she thought. <em>All of them.</em></p><p>She poured her tea. Sat at the small table by the door. Opened her notebook — not her phone, not first thing — and wrote three sentences about whatever was true right now.</p><p><em>The bread seller's tray catches the light. My tea is too hot. I am still here.</em></p><p>That last one always surprised her. Not in a dark way. In the way of a gift you don't expect — the simple, stubborn fact of continuity. Of having arrived, again, at another morning.</p><p>She finished her tea. Stood. Got dressed with the particular care of someone who believed that how you put yourself together said something, even if no one was watching — <em>especially</em> if no one was watching.</p><p>At five forty-seven, she opened the front door.</p><p>The heat hit her like a reminder.</p><p>She smiled at it — <em>old friend</em> — and stepped out to meet the day.</p>` },
