    ...
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', zIndex: 1000, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}
      ...
      <div style={{ background: '#141414', border: '1px solid rgba(255,255,255,0.09)', borderRadius: '20px 20px 0 0', width: '100%', maxWidth: 520, padding: '2rem 1.5rem 2.5rem', maxHeight: '90vh', overflowY: 'auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.75rem' }}>
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.82)', fontSize: '1.4rem', cursor: 'pointer', padding: 0, lineHeight: 1 }}>×</button>
        </div>
        {loadingUsers ? (
...
export default function UserPage() {
  ...
  if (!uid || !profileData) return (
    <div style={{ minHeight: '100vh', background: '#0d0d0d', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <p style={{ color: 'rgba(255,255,255,0.82)', fontFamily: 'Inter, sans-serif', fontSize: '0.85rem' }}>User not found.</p>
    </div>
  );
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .up-nav-back { font-size: 0.65rem; color: rgba(255,255,255,0.82); letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; transition: color 0.2s; }
        .up-nav-back:hover { color: rgba(255,255,255,0.82); }
        ...
        .up-follow-label { font-size: 0.56rem; color: rgba(255,255,255,0.8); letter-spacing: 0.1em; text-transform: uppercase; font-family: 'Inter', sans-serif; }
        .up-joined { font-size: 0.7rem; color: rgba(255,255,255,0.78); font-family: 'Inter', sans-serif; margin-bottom: 0.85rem; }
        ...
        .up-follow-btn.following { background: transparent; border: 1px solid rgba(255,255,255,0.15); color: rgba(255,255,255,0.75); }
        ...
        .up-stat-label { font-size: 0.56rem; color: rgba(255,255,255,0.8); letter-spacing: 0.14em; text-transform: uppercase; font-family: 'Inter', sans-serif; }
        ...
        .up-section-meta { font-size: 0.6rem; color: rgba(255,255,255,0.75); letter-spacing: 0.12em; text-transform: uppercase; font-family: 'Inter', sans-serif; }
        ...
        .up-story-author { font-size: 0.68rem; color: rgba(255,255,255,0.8); font-family: 'Inter, sans-serif'; margin-top: 2px; }
        ...
        .up-signin-prompt { font-size: 0.78rem; color: rgba(255,255,255,0.78); font-family: 'Inter', sans-serif; font-style: italic; padding: 0.75rem 0; }
